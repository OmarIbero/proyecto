...
const setNotificationState = ({img="/makefs/views/iconos/book.png",msg="Bookshlef Notification",isLoad=false,hideButton=true,recipeCancelId,recipeTitle,containerPos}) => {
...
const axiosToLib = (libVideoId,videoTitle,recipePos) => {
    ...
    .then((res) => {
        ...
        if (res.data == "removed"){
            ...
            setNotificationState({img:"/makefs/views/iconos/remove-book.png",msg:msg,isLoad:false,hideButton:false,recipeCancelId:libVideoId,recipeTitle:videoTitle,containerPos:recipePos});
            ...
            setNotificationState({img:"/makefs/views/iconos/book.png",msg:msg,isLoad:false})
            allRecipes[parseInt(recipePos)].removeAttribute("style");
        }else{
            setNotificationState({img:"/makefs/views/iconos/loading-circles.png",msg:responseStates.error,isLoad:true})
        }
        if (asyncHandler.nextInPile.length > 0) {
            asyncHandler.pileNextHandler = setTimeout(() => {
                ...
                setNotificationState({img:"/makefs/views/iconos/loading-circles.png",msg:responseStates.loading,isLoad:true})
