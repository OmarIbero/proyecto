...
<body class="White">
    ...
    <section id="continfo">
        <div class="viewlogo">
            <a href="/makefs/"><img src="views/img/makefsinvert.jpg" alt="logo makefs"></a>
            <h6>makef's</h6>
        </div>
        <div class="formcont">
            <div class="info-form">
                <form action="controllers/registerC.php" method="POST" class="form-done WhiteForm">
                    <a class="aback aWhite" href="/makefs/"><img class="Whiteimg"src="views/iconos/second-back.svg" alt="backbtn"><h6 class="Whiteback">Volver</h6></a>
                    ...
                    <h4 class="aregister Whiteform"><p>Ya tienes una cuenta?</p><span><a href="/makefs/login"> Inicia sesion!</a></span></h4>
                </form>
            </div>
        </div>
    </section>
