        ...
        <div class="formcont">
            <div class="info-form">
                <form action="controllers/loginC.php" method="POST" class="form-done">
                    <a class="aback" href="/makefs/"><img class="Whiteimg" src="views/iconos/second-back.svg" alt="backbtn"><h6 class="Whiteback">Volver</h6></a>
                    ...
                    <h4 class="aregister Whiteform"><p>No tienes una cuenta?</p><span><a href="/makefs/register"> Registrate!</a></span></h4>
