...
<html lang="en">
    <head>
        ...
        <link href="/makefs/views/css/DarkModeIndex.css" rel="stylesheet">
...
<body class="White">
                    ...
                    echo <<<EOT
                        <div class="recipe-template">
                            <a class="image-template" href="/makefs/recipe/$recipe->recipeid">
                                <img src="/makefs/mediaDB/recipeImages/$recipe->imagen" alt="recetas comida">
                                <figure class="star-template WhiteStar"><img src="/makefs/views/img/hico-star-red.png" alt="estrellas de valoracion"><b id="starCount">$recipe->rate</b></figure>
                            </a>
                            <div class="next-text-recipe WhiteModeP">
                                <img src="/makefs/mediaDB/usersImg/$recipe->chefpic" alt="imagen de usuario">
                                <div>
                ...
                if(empty($recipe) && empty($recipe)){
                    echo <<<EOT
                        <div id="notFoundRecipes" class="Whitecookie">
                            <img src="/makefs/views/img/notrecipesSearch.png" alt="noSeEncontraronRecetas">
    ...
    <script src="/makefs/views/js/darkModeIndex.js"></script>
