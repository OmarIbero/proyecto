...
<head>
    ...
    <link rel="stylesheet" href="/makefs/views/css/normalize.css">
    <link rel="stylesheet" href="/makefs/views/css/chefinx.css">
    <link rel="stylesheet" href="/makefs/views/css/newRecipeCss.css">
    <link rel="stylesheet" href="/makefs/views/css/newRecipeEdit.css">
    <link rel="stylesheet" href="/makefs/views/css/header.css">
    <link rel="stylesheet" href="/makefs/views/css/footer.css">
    <link rel="stylesheet" href="/makefs/views/css/DarkEdit.css">
...
<body class="White">
                ...
                <div id="sectionEditRecipeMultimedia">
                    <div id="stepsEditRecipe">
                        <div id="tittlePasos" class="Whitemaintt">
                            <div id="hatPasosyTxt">
                                <img src="/makefs/views/img/chefHatRed.png" alt="chef hat">
                                <h2>Pasos</h2>
                            </div>
                            <div id="btnsSteps">
    ...
    <div class="mini-reproductor MRShowing">
        <video controls="true" src="<?php echo "/makefs/mediaDb/recipeVideos/$data[video]"?>"></video>
    ...
    <script src="/makefs/views/js/editRecipe.js"></script>
    <script src="/makefs/views/js/axiosEditRecipe.js"></script>
    <script src="/makefs/views/js/DarkModeM.js"></script>
    <script src="/makefs/views/js/mediaPlayer.js"></script>
    <script src="/makefs/views/js/DarkModeEdit.js"></script>
</body>
</html>