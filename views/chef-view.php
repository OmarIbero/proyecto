...
<head>
    ...
    <link href="/makefs/views/css/chef-view-change.css" rel="stylesheet">
    <link href="/makefs/views/css/notifications.css" rel="stylesheet">
    <link href="/makefs/views/css/DarkModecss.css" rel="stylesheet">
    <link rel="stylesheet" href="/makefs/views/css/DarkMenu.css">
...
<body class="White">
                ...
                <div class="chef-char">
                    <div class="char-template">
                        <figure class="profile-pic">
                            <img class="profile-pic-img" src="/makefs/mediaDb/usersImg/<?php echo $res['midpic']; ?>" alt="imagen de usuario">
                            <?php if($isTheChef){ echo "<a id='profile-edit'></a>";} ?>
                            <?php if($isVerify){ echo "<img class='verified' src='/makefs/views/img/chef-verified.png' alt='verificacion'> ";} ?>
                            <div class="followers" ><img src="/makefs/views/img/hico-followers.png" alt="seguidores"><p id="followersSection" ><?php echo $seguidores ?></p></div>
                        </figure>
                        <article class="profile-chars">
                            ...
                            <ul class="chef-social-media">
                                <a href="<?php echo test_input($res["facebook"]) ?>" id="fbTxT" target="__blank"><img src="/makefs/views/img/user-facebook.png" alt="facebookPage"></a>
                                <a href="<?php echo test_input($res["instagram"]) ?>" id="igTxT" target="__blank"><img src="/makefs/views/img/user-instagram.png" alt="instagramPage"></a>
                                <a href="<?php echo test_input($res["twitter"]) ?>" id="twTxt" target="__blank"><img src="/makefs/views/img/user-twitter.png" alt="twitterPage"></a>
                                <a href="<?php echo test_input($res["youtube"]) ?>" id="ytTxT" target="__blank"><img src="/makefs/views/img/user-youtube.png" alt="youtubeChannel"></a>
                            </ul>
                            <?php
                                if($_SESSION['id']==0){
                                    echo <<<EOT
                    ...
                    if($isTheChef){
                        echo <<<EOT
                            <div class="action-buttons-container">
                                <a href="/makefs/newrecipe" class="action-btn"><img src="/makefs/views/img/chef-add.png" alt="agregar"><p>Añadir recetas</p></a>
                                <a class="action-btn"><img src="/makefs/views/img/chef-flag.png" alt="reportar"><p>Reportes</p></a>
                    ...
                    $username = test_input($res['username']);
                        echo <<<EOT
                            <div class="recipe-template editable-recipe">
                                <a class="image-template" href="/makefs/recipe/$dataRecipes[recipeid]">
                                    <img src="/makefs/mediaDb/recipeImages/$dataRecipes[imagen]" alt="imagen de receta">
                                    <figure class="star-template WhiteStar"><img src="/makefs/views/img/hico-star-red.png" alt="estrellas de receta"><b id="starCount">$dataRecipes[rate]</b></figure>
                                </a>
                                <div class="next-text-recipe WhiteModeP">
                                    <img src="/makefs/mediaDb/usersImg/$res[midpic]" alt="imagen de usuario">
                                    <div>
                                        <a href="/makefs/recipe/$dataRecipes[recipeid]"><h3 class="text-template">$tittle</h3></a>
                                        <a href="/makefs/chef/$res[chefid]">
                                            <p>$username</p>
                        ...
                        if($isTheChef){
                            echo <<<EOT
                                <div id="notFoundRecipes" class="WhiteBannerNone">
                                    <img src="/makefs/views/img/notFoundRecipes.png" alt="recetas no encontradas">
        ...
        <div id="chefContainer" class="WhiteChefCont">
            <div class="divChef-view" id="firstdiv-chef">
                <figure class="profile-pic-chef" id="change-chef-info-pic">
                        <img class="profile-pic-img-chef" src="/makefs/mediaDb/usersImg/<?php echo $res['midpic']; ?>" alt="imagen de usuario">
                        <?php if($isVerify){ echo "<img class='verified' src='/makefs/views/img/chef-verified.png' alt='verificacion'> ";} ?>
    ...
    <?php
        if($_SESSION['id']!=0){
            echo <<<EOT
                <script src="/makefs/views/js/chageInfoUserChef.js"></script>
                <script src="/makefs/views/js/upload_pic_chef.js"></script>
                <script src="/makefs/views/js/axiosFollow.js"></script>
                <script src="/makefs/views/js/axiosChef.js"></script>
            EOT;
        }
    ?>
    
    <script src="/makefs/views/js/index.js"></script>
    <script src="/makefs/views/js/chef-view.js"></script>
    <script src="/makefs/views/js/menuDesplegable.js"></script>
    <script src="/makefs/views/js/followUnloged.js"></script>
    <script src="/makefs/views/js/darkMode.js"></script>
