...
$directory = "/makefs/mediaDB/usersImg/";
...
try{
    if ($_SESSION["midpic"] != "makefsUser.png" && $_SESSION["midpic"] != "makefsUser.png"
        ...
        unlink("/makefs/mediaDb/usersImg/".$_SESSION["midpic"]);
        unlink("/makefs/mediaDb/usersImg/".$_SESSION["minpic"]);
    }
}catch(Exception $e){
...
$jsonEcho = json_encode(array("msg"=>"success_200","newMidImg"=>"/makefs/mediaDb/usersImg/".$_SESSION["midpic"],"newMinImg"=>"/makefs/mediaDb/usersImg/".$_SESSION["minpic"]));
echo $jsonEcho;
?>